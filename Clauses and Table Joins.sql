...
-- CREATE TABLE Location (location_id INT AUTO_INCREMENT PRIMARY KEY,location VARCHAR(50) NOT NULL UNIQUE);
...
-- -- Step 4: Now insert data (MySQL knows to put it in 'employee')
